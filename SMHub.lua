...
makeLabel(aimbotContent,"EXTRAS",246,PURPLE)

makeToggle(aimbotContent,"Wall Check",264,true,function(v)
    SETTINGS.WallCheck = v
end)
makeToggle(aimbotContent,"Auto Shoot",312,false,function(v)
...
RunService.Heartbeat:Connect(function()
    ...
    if SETTINGS.AutoShoot then internalShoot() end
end)
